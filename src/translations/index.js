export const t = {
  en: {
    ...
    installation: {
      ...
      standaloneDev: 'The Windows x64 portable package includes SNM.exe, AI models (~5.1 GB), and all dependencies. Linux and macOS builds are coming soon.',
  ...
  fr: {
    ...
    installation: {
      ...
      standaloneDev: 'Le package portable Windows x64 inclut SNM.exe, les modèles IA (~5,1 Go) et toutes les dépendances. Linux et macOS arrivent bientôt.',
      standalonePlatforms: ['Windows (x64)', 'Linux (x64)', 'macOS (Intel/Silicon)'],

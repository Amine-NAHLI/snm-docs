export const t = {
  en: {
    ...
    installation: {
      ...
      standaloneBadge: 'Coming Soon',
      standaloneDesc: 'Direct download of self-contained executables for major platforms. No Python installation required.',
      standaloneDev: 'This feature is currently under development. Native binaries for Windows (.exe), Linux (AppImage/Binary), and macOS (.app) are being compiled and tested.',
  ...
  fr: {
    ...
    installation: {
      ...
      standaloneBadge: 'Bientôt Disponible',
      ...
      standaloneDev: 'Cette fonctionnalité est actuellement en cours de développement. Les binaires natifs pour Windows (.exe), Linux (AppImage/Binaire) et macOS (.app) sont en cours de compilation et de test.',
      standalonePlatforms: ['Windows (x64)', 'Linux (x64)', 'macOS (Intel/Silicon)'],
